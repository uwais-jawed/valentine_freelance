...
loveMeter.addEventListener('input', () => {
    ...
    if (value > 100) {
        ...
        // Dynamically generate "Hoooo..." message
        // For every 500 on the meter, add another "o"
        let oCount = Math.floor((value - 100) / 500) + 2; // minimum 2 o's
        if (oCount > 50) oCount = 50; // prevent it from getting too long
        const hoMessage = "H" + "o".repeat(oCount) + "!";
        extraLove.classList.remove('super-love');
        extraLove.textContent = hoMessage;
    } else {
